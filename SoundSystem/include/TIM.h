...
void TIM_OCPreloadConfig(TIM_TypeDef* TIMx,
                         uint8_t TIM_OCChannel,
                         uint16_t TIM_OCPreload);

void TIM_OCFastConfig(TIM_TypeDef* TIMx,
                      uint8_t TIM_OCChannel,
                      uint16_t TIM_OCFast);
...
void TIM_ClearOCRef(TIM_TypeDef* TIMx,
                      uint8_t TIM_OCChannel,
                      uint16_t TIM_OCClear);

void TIM_OCPolarityConfig(TIM_TypeDef* TIMx,
                      uint8_t TIM_OCChannel,
                      uint16_t TIM_OCPolarity);

void TIM_ICSetCompare(TIM_TypeDef* TIMx,
...
//   TIM_CounterMode_CenterAligned1 - OC IRQ flags are only set when counting down
//   TIM_CounterMode_CenterAligned2 - OC IRQ flags are only set when counting up
//   TIM_CounterMode_CenterAligned3 - OC IRQ flags are set both when counting up and down
